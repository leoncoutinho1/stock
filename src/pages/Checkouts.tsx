    ...
    <div className="space-y-4 animate-in fade-in duration-200">
      <form onSubmit={handleCreate} className="bg-slate-900 border border-slate-800 rounded-3xl p-4 space-y-3">
        <h3 className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
          <Monitor className="w-4 h-4 text-indigo-400" /> Novo Terminal / Guichê Checkout
        </h3>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 space-y-2">
        <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Terminais Cadastrados</h3>
        {loading ? (
          ...
          <p className="text-center py-6 text-slate-500 text-xs">Nenhum checkout cadastrado.</p>
        ) : (
